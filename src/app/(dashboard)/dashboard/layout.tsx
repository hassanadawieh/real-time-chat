  ...
  return (
    <div className="w-full flex h-screen">
     ...
     <MobileChatLayout friends={friends} session={session} sidebarOptions={sidebarOptions} unseenRequestCount={unseenRequestCount} />
                ...
                {sidebarOptions.map((option) => {
                  ...
                  return (
                    <li key={option.id}>
                      ...
                      >
                        <span className="text-gray-400 border-gray-200 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg text-[0.625rem] font-medium bg-white">
      ...
      <aside className="max-h-screen container pt-16 md:py-12 w-full">{children}</aside>
